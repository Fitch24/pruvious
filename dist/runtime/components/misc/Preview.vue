...
<style scoped>
.rect{border:1px solid var(--pruvious-preview-color,rgba(6,82,221,.75));pointer-events:none;top:0;z-index:999999}.label,.rect{box-sizing:border-box;overflow:hidden;position:absolute}.label{background:var(--pruvious-preview-color,rgba(6,82,221,.75));color:var(--pruvious-preview-text-color,#fff);display:block;font-family:Arial;font-size:12px;line-height:1;max-width:100%;padding:3px 4px;right:1px;text-overflow:ellipsis;top:1px;white-space:nowrap}
</style>
