 ...
 * ```
 */
export declare function resolvePagePath(path: string, collectionName: CollectionName, language?: any): Promise<string>;
/**
 ...
 * ```
 */
export declare function resolveLanguage(input: any): SupportedLanguage;
