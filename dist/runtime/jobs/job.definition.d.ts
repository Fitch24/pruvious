...
export type ResolvedJobDefinition<T extends (...args: any[]) => any | Promise<any>> = JobDefinition<T> & Required<Pick<JobDefinition<T>, 'priority' | 'interval'>>;
/**
 * Define a new job.
 */
export declare function defineJob<T extends (...args: any[]) => any | Promise<any>>(definition: JobDefinition<T>): ResolvedJobDefinition<T>;
