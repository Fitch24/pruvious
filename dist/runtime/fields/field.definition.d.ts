...
import type { ExtractKeywordsContext, ResolvedCollectionDefinition } from '../collections/collection.definition.js';
import { query } from '../collections/query.js';
import type { QueryBuilderInstance } from '../utility-types.js';
import type { _, __ } from '../utils/server/translate-string.js';
...
export type FieldGuardContext = FieldInputContext & TranslationHelpersContext & {
    /**
...
export type FieldValidatorContext = FieldInputContext & TranslationHelpersContext & {
    /**
...
export type FieldGuard = ((context: FieldGuardContext) => any | Promise<any>) | {
    /**
...
export type FieldSanitizer = ((context: FieldSanitizerContext) => any | Promise<any>) | {
    /**
...
export type FieldValidator = ((context: FieldValidatorContext) => any | Promise<any>) | {
    /**
...
export declare function dbToJsType(type: 'BIGINT' | 'BOOLEAN' | 'DECIMAL' | 'INTEGER' | 'TEXT' | undefined): "string" | "number" | "boolean" | "unknown";
export declare function resolveFieldPopulation(population: FieldPopulation | false | undefined): ResolvedFieldPopulation | false;
/**
 ...
 */
export declare function defineField(definition: FieldDefinition): ResolvedFieldDefinition;
