 ...
 */
export declare function vueField<T, S extends T>(options: Omit<FieldOptions['chips'], 'overrideType'> & {
 ...
 * @see https://pruvious.com/docs/creating-blocks
 */
export declare function vueSubfield<T, S extends T>(options: Omit<FieldOptions['chips'], 'overrideType'> & {
    choices: Record<T, string>;
    default?: (S & string)[];
