 ...
 */
export declare function vueField<T, S extends T>(options: Omit<FieldOptions['button-group'], 'overrideType'> & {
 ...
 * @see https://pruvious.com/docs/creating-blocks
 */
export declare function vueSubfield<T, S extends T>(options: Omit<FieldOptions['button-group'], 'overrideType'> & {
    choices: Record<T, string>;
    default?: S & string;
