...
import { capitalize, isString, isUrlPath, joinRouteParts, removeAccents, titleCase } from "../utils/string.js";
import { lowercaseValidator } from "../validators/string.js";
import { uniqueValidator } from "../validators/unique.js";
export function pageLikeCollection(options) {
          ...
          validators: [
            {
              ...
              validator: async ({ __, errors, input, language, value }) => {
                ...
                const { layouts: layouts2 } = await import("#pruvious/layouts");
