...
import { s3DeleteObject, s3MoveObject, s3PutObject } from "../instances/s3.js";
import { getModuleOption } from "../instances/state.js";
import { format } from "../utils/bytes.js";
import { objectOmit, objectPick } from "../utils/object.js";
import { __ } from "../utils/server/translate-string.js";
import { joinRouteParts } from "../utils/string.js";
import { generateImagePaths, getOptimizedImage } from "./images.js";
import {
  QueryBuilder
} from "./query-builder.js";
export class UploadsQueryBuilder extends QueryBuilder {
  /**
          ...
          try {
            ...
            if (from !== to) {
              ...
              for (const image of images.filter((image2) => +image2.upload_id === record.id)) {
                ...
                const promises = [];
                if (options.drive.type === "local") {
                  fs.moveSync(path.resolve(from2), path.resolve(to2), { overwrite: true });
                } else {
