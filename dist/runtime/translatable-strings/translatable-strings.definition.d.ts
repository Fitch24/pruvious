...
import type { ConditionalRule } from '../fields/field.definition.js';
 ...
 * ```
 */
export declare function defineTranslatableStrings(definition: TranslatableStringsDefinition): Required<TranslatableStringsDefinition>;
