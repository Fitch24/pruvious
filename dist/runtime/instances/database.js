...
import { clearArray, isArray } from "../utils/array.js";
import { foreignKeyConstraintName, getDatabaseInfo, indexName } from "../utils/database.js";
import { isDebugActive } from "../utils/debug.js";
import { sleep } from "../utils/function.js";
import { camelCase, snakeCase } from "../utils/string.js";
...
export async function rebuildDatabase(fields, collections, log = true) {
  while (status === "rebuilding") {
    await sleep(50);
  }
  status = "rebuilding";
